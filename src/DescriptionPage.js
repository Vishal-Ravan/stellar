        ...
        <div className={classes.fullDiv}>
            ...
            <div className={classes.descriptinMainDiv}>
                <Grid className={classes.descriptionEvent} md={12}>
                    <img src="https://www.informaticsinc.com/application/files/6916/4392/3704/Blog-P-Max-HERO_450_X_250.jpg" alt="" width='60%' height="190vh" />
                </Grid>
            ...
            <div className={classes.information}>
                ...
                <Grid className={classes.btnDescription}>
                    <Button className={classes.btnDescript}><p className={classes.pbtn}>{<ArrowForwardIosOutlinedIcon />}{t('common:RegisterasMentee', "   Register as Mentee")}</p></Button>
                    <Button className={classes.btnDescript1} ><p className={classes.pbtn}> {<ArrowForwardIosOutlinedIcon />} {t('common:Registerasmentor', "   Register as mentor")} </p></Button>
                </Grid>
            </div>
        </div>
    </>
